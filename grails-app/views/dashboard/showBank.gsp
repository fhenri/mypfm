	...
	<body>
		...
		<div id="show-bank" class="content scaffold-show" role="main">
			...
			<ol class="property-list bank">
				...
				<g:if test="${bankInstance?.iBanCode}">
				<li class="fieldcontain">
					<span id="iBanCode-label" class="property-label"><g:message code="bank.iBanCode.label" default="IB an Code" /></span>
					
						<span class="property-value" aria-labelledby="iBanCode-label"><g:fieldValue bean="${bankInstance}" field="iBanCode"/></span>
